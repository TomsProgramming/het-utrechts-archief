            ...
            <form method="POST" action="" class="mt-10 space-y-8">
                ...
                <div>
                    ...
                    <input id="email" type="email" name="email" value="{{ old('email') }}" required autofocus
                        class="w-full p-3 outline-0 border-2 border-t-0 border-gray-300">
                    @error('email')
                ...
                <div class="flex items-center justify-between text-sm mt-2">
                    <label class="inline-flex items-center space-x-2 cursor-pointer select-none">
                        <input type="checkbox" name="remember" class="h-4 w-4 border-gray-400"
                ...
                <div class="mt-8 flex items-center space-x-4">
                    <button type="submit" class="bg-red text-white px-8 py-3 text-lg font-bold">
                        Inloggen
                    </button>
                </div>
            </form>
